"""
Test script to verify compact value display with inline units.
"""
...
def test_compact_value_display():
    """Test the compact value display implementation."""
    
    app = QApplication(sys.argv)
    
    # Create main window
    window = QMainWindow()
    window.setWindowTitle("Compact Value Display Test")
    ...
    print("Compact Value Display Test")
    print("=" * 50)
    print("\nTest Results:")
    ...
    print("[OK] Font size increased to 48pt")
